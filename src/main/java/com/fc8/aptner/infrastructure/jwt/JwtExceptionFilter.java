...
public class JwtExceptionFilter extends OncePerRequestFilter {
    ...
    private void sendJwtException(HttpServletResponse response, JwtException exception) throws IOException {
    ...
    private String getErrorResponseEntity(JwtException exception) throws JsonProcessingException {
