...
public interface PostRepository {
    ...
    Page<Post> getPostListByApartCodeAndApartAreaId(Long memberId, String apartCode, Long apartAreaId, Pageable pageable, String search, SearchType type, String categoryCode);
